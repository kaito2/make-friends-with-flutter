...
class TeamSingleScreen extends StatelessWidget {
  static const paramKey = 'teamID';
  static String _routePath(param) => '/teams/$param';

  static String routePath = _routePath(':$paramKey');
  static String buildRoutePath(String teamID) => _routePath(teamID);
